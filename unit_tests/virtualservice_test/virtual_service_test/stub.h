...
class	virtual_service_test_struct{
protected:
	virtual_service_test_struct() :
								basefunctioncallcount( 0 ),
								tcpfunctioncallcount( 0 ),
								udpfunctioncallcount( 0 ) {}

//	virtual_service_test_struct( const virtual_service_test_struct & in ) {}
//	virtual_service_test_struct& operator=( const virtual_service_test_struct & in ){ return *this; }
public:
	int		basefunctioncallcount;
	int		tcpfunctioncallcount;
	int		udpfunctioncallcount;

	static virtual_service_test_struct&	getInstance(){
		static	virtual_service_test_struct	instance;
		return	instance;
	}
};
