...
public:
	...
	void	register_schedule( schedule inschedule );
	...
	EVENT_TAG	handle_realserver_select(
								const boost::thread::id thread_id,
								boost::asio::ip::basic_endpoint & rs_endpoint );

	EVENT_TAG	handle_realserver_connect(
								const boost::thread::id thread_id,
								const boost::array<char,MAX_BFFER_SIZE>& sendbuffer );
	...
	EVENT_TAG	handle_sorryserver_select(
								const boost::thread::id thread_id,
								boost::asio::ip::basic_endpoint & sorry_endpoint );
