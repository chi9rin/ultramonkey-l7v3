...
usleep 100000
$L7VSADM -A -t 127.0.0.1:40001 -m ip --sorry-uri /sorry.html --forwarded-for -b 127.0.0.1:9876
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40001 -m ip --sorry-uri /sorry.html --forwarded-for -b 127.0.0.1:9876"
        exit 1
fi
