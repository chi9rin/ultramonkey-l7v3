...
usleep 100000
$L7VSADM -A -t 127.0.0.1:40001 -m ip --sorry-uri "/a/b/c/../d/e;f?g=h&i=%FF%00#jk"
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40001 -m ip --sorry-uri /a/b/c/../d/e;f?g=h&i=%FF%00#jk"
        exit 1
fi

$L7VSADM -A -t 127.0.0.1:40002 -m ip -S "/a/b/c/../d/e;f?g=h&i=%FF%00#jk"
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40002 -m ip -S /a/b/c/../d/e;f?g=h&i=%FF%00#jk"
        exit 1
fi
