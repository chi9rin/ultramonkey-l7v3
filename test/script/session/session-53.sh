...
# set config file
. ${SET_DEFAULT_CONF}
\cp -f materials/session-53-l7vs.cf ${L7VSD_CONF_DIR}/l7vs.cf
\cp -f materials/session-53-sslproxy.target.cf ${L7VSD_CONF_DIR}/sslproxy/sslproxy.target.cf
mkdir -p ${L7VSD_CONF_DIR}/sslproxy/cert/
\cp -f materials/session-53-newkey.der ${L7VSD_CONF_DIR}/sslproxy/cert/newkey.der
