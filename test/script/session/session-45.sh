...
# set config file
. ${SET_DEFAULT_CONF}
\cp -f materials/session-45-l7vs.cf ${L7VSD_CONF_DIR}/l7vs.cf
...
RET=`cat ${L7VS_LOG_DIR}/l7vsd.log | egrep "\[DEBUG\] l7vsd_session VSD10900005 Thread ID\[.*\] tcp_socket::connect \[127.0.0.1:50001\]"` 
if [ -z "${RET}" ]
then
