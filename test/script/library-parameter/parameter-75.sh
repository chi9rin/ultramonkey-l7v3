...
$L7VSADM -A -t 127.0.0.1:44432 -m sessionless -z ${L7VSD_CONF_DIR}/sslproxy/sslproxy.target.cf
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:44432 -m sessionless -z ${L7VSD_CONF_DIR}/sslproxy/Temp_sslproxy.target.cf"
        exit 1
fi
