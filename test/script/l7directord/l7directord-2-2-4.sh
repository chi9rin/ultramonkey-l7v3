#!/bin/bash
. ${SET_DEFAULT_CONF}
\cp ./materials/l7directord-2-2-4-1-l7directord.cf ${L7DIRECTORD_CONF_DIR}/l7directord.cf
...
\cp ./materials/l7directord-2-2-4-2-l7directord.cf ${L7DIRECTORD_CONF_DIR}/l7directord.cf
