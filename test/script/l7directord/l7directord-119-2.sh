...
\cp -p ./materials/l7directord-119-execute.cf ${L7DIRECTORD_CONF_DIR}/execute.cf
sed "s|XXX|${L7DIRECTORD_CONF_DIR}/execute.cf|g" ./materials/l7directord-119-l7directord.cf > ${L7DIRECTORD_CONF_DIR}/l7directord.cf
