#!/bin/bash
. ${SET_DEFAULT_CONF}
\cp ./materials/l7directord-4-4-4-l7directord.cf ${L7DIRECTORD_CONF_DIR}/l7directord.cf
...
#[Wed Oct  6 14:59:42 2010|30786] [INF0402] Create health check process with pid: 30859.
...
#[Wed Oct  6 14:59:45 2010|30859] [WRN3101] Service check NG. Ping timeout in 3 seconds.
timeout_line=`grep "WRN3101" ${L7VS_LOG_DIR}/l7directord.log`
if [ -n $timeout_line ]; then
        echo "Test failed: Cannot find ping timeout message in the log."
        exit 1
fi
