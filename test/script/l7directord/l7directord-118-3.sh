...
\cp -p ./materials/l7directord-118-callback.sh ${L7DIRECTORD_CONF_DIR}/callback.sh
sed "s|XXX|${L7DIRECTORD_CONF_DIR}/callback.sh|g" ./materials/l7directord-118-l7directord.cf > ${L7DIRECTORD_CONF_DIR}/l7directord.cf
