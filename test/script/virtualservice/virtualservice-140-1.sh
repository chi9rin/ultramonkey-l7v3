...
# set config file
. ${SET_DEFAULT_CONF}
\cp -f materials/virtualservice-140-1-l7vs.cf ${L7VSD_CONF_DIR}/l7vs.cf
\cp -f materials/virtualservice-140-1-sslproxy.target.cf ${L7VSD_CONF_DIR}/sslproxy/sslproxy.target.cf
