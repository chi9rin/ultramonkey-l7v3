...
$L7VSADM -A -t 127.0.0.1:40001 -m ip -Q 100K -q 100K
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40001 -m ip -Q 100K -q 100K"
        exit 1
fi

$L7VSADM -A -t 127.0.0.1:40002 -m ip -Q 100M -q 100M
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40002 -m ip -Q 100M -q 100M"
        exit 1
fi
