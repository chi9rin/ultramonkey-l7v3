#!/bin/bash
. ${SET_DEFAULT_CONF}
\cp ./materials/C-2-IPv6v4-l7directord.cf ${L7DIRECTORD_CONF_DIR}/l7directord.cf
...
iptables -A INPUT -s $RS2 -p icmp -j DROP
sleep 30
