...
#Check Return Value
RET=`snmpget -v 2c -c public localhost ULTRAMONKEY-L7-MIB::l7vsVsProtocolModuleName.1`

EXPECT="ULTRAMONKEY-L7-MIB::l7vsVsProtocolModuleName.1 = STRING: "sessionless""

if [ "${RET}" != "${EXPECT}" ]
then
        echo "snmpget -v 2c -c public localhost ULTRAMONKEY-L7-MIB::l7vsVsProtocolModuleName.1"
        exit 1
fi
