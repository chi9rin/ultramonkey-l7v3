...
#Check Return Value
RET=`snmpget -v 2c -c public localhost ULTRAMONKEY-L7-MIB::l7vsVsThroughputDownQos.1`

EXPECT="ULTRAMONKEY-L7-MIB::l7vsVsThroughputDownQos.1 = Counter64: 200 B/s"

if [ "${RET}" != "${EXPECT}" ]
then
        echo "Test failed: snmpget -v 2c -c public localhost ULTRAMONKEY-L7-MIB::l7vsVsThroughputDownQos.1"
        exit 1
fi
