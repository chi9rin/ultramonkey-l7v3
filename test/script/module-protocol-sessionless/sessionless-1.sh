...
$L7VSADM -a -t 127.0.0.1:40001 -m sessionless -r ${RealServer2_ADDR}:${RealServer2_PORT}
if [ $? -ne 0 ]
then
...
$L7VSADM -a -t 127.0.0.1:40001 -m sessionless -r ${RealServer3_ADDR}:${RealServer3_PORT}
if [ $? -ne 0 ]
then
	echo "Test failed: $L7VSADM -a -t 127.0.0.1:40001 -m sessionless -r ${RealServer3_ADDR}:${RealServer3_PORT}"
        exit 1
fi
