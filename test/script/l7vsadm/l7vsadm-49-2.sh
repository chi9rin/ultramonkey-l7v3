...
RET=`$L7VSADM -A -t 127.0.0.1:40001 -m ip -b 333.333.333.333:3333 2>&1 | grep "PARSE ERROR : sorryserver endpoint parse error:invalid endpoint:Host not found (non-authoritative), try again later:333.333.333.333:3333"`
