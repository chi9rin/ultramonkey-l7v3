...
$L7VSADM --edit-server --tcp-service 127.0.0.1:40001 --proto-module ip --real-server ${RealServer1_ADDR}:${RealServer1_PORT} --weight 2
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM --edit-server --tcp-service 127.0.0.1:40001 --proto-module ip --real-server ${RealServer1_ADDR}:${RealServer1_PORT} --weight 2"
        exit 1
fi
