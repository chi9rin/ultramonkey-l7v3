...
$L7VSADM --delete-service --tcp-service localhost:40001 --proto-module sessionless
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM --delete-service --tcp-service localhost:40001 --proto-module sessionless"
        exit 1
fi
