...
$L7VSADM -a -t localhost6:40001 -m sessionless -r localhost4:${RealServer1_PORT} -w 3
if [ $? -ne 0 ]
then
...
$L7VSADM -a -t localhost6:40001 -m sessionless -r localhost4:${RealServer2_PORT} -w 0
if [ $? -ne 0 ]
then
