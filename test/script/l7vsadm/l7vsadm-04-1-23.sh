...
$L7VSADM -A -t localhost:40001 -m sessionless -f 1
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t localhost:40001 -m sessionless -f 1"
        exit 1
fi
...
$L7VSADM -E -t localhost:40001 -m sessionless -f 0
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -E -t localhost:40001 -m sessionless -f 0"
        exit 1
fi
