...
if [ $? -ne 0 ]
then
        echo "Test failed: start_lighttpd SorryServer2"
        exit 1
fi
...
TCP 127.0.0.1:40002 sessionless rr --sorry-uri '/'
    ${SorryServer2_ADDR}:${SorryServer2_PORT}(Masq) 0 0
    0 0
    0 0
    none
    none
    ...
    none
    --ac-rotate-type size --ac-rotate-max-backup-index 10 --ac-rotate-max-filesize 10M
TCP 127.0.0.1:40003 sessionless rr --sorry-uri '/'
    ${SorryServer1_ADDR}:${SorryServer1_PORT}(Tproxy) 0 0
    0 0
    0 0
    none
    none
    ...
    none
    --ac-rotate-type size --ac-rotate-max-backup-index 10 --ac-rotate-max-filesize 10M
TCP 127.0.0.1:40004 sessionless rr --sorry-uri '/'
    ${SorryServer2_ADDR}:${SorryServer2_PORT}(Tproxy) 0 0
    0 0
    0 0
    none
    none
...
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -E -t 127.0.0.1:40002 -m sessionless -f 1"
        exit 1
fi

$L7VSADM -E -t 127.0.0.1:40003 -m sessionless -f 1
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -E -t 127.0.0.1:40003 -m sessionless -f 1"
        exit 1
fi
...
TCP 127.0.0.1:40001 sessionless rr --sorry-uri '/'
    ...
    --ac-rotate-type size --ac-rotate-max-backup-index 10 --ac-rotate-max-filesize 10M
TCP 127.0.0.1:40002 sessionless rr --sorry-uri '/'
    ${SorryServer2_ADDR}:${SorryServer2_PORT}(Masq) 0 1
    0 0
    0 0
    none
    none
    ...
    --ac-rotate-type size --ac-rotate-max-backup-index 10 --ac-rotate-max-filesize 10M
TCP 127.0.0.1:40003 sessionless rr --sorry-uri '/'
    ${SorryServer1_ADDR}:${SorryServer1_PORT}(Tproxy) 0 1
    0 0
    0 0
    none
    none
    ...
    --ac-rotate-type size --ac-rotate-max-backup-index 10 --ac-rotate-max-filesize 10M
TCP 127.0.0.1:40004 sessionless rr --sorry-uri '/'
    ${SorryServer2_ADDR}:${SorryServer2_PORT}(Tproxy) 0 1
    0 0
    0 0
    none
    none
