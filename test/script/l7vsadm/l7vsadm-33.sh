...
$L7VSADM -a -t 127.0.0.1:40001 -m ip --timeout 100 -r ${RealServer1_ADDR}:${RealServer1_PORT}
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -a -t 127.0.0.1:40001 -m ip --timeout 100 -r ${RealServer1_ADDR}:${RealServer1_PORT}"
        exit 1
fi
