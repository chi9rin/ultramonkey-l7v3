...
$L7VSADM -A -t 127.0.0.1:40001 -m sessionless -q 1M -Q 100M
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40001 -m sessionless -q 1M -Q 100M"
        exit 1
fi

$L7VSADM -A -t 127.0.0.1:40002 -m sessionless -Q 100M -q 1M
if [ $? -ne 0 ]
then
        echo "Test failed: $L7VSADM -A -t 127.0.0.1:40002 -m sessionless -Q 100M -q 1M"
        exit 1
fi
