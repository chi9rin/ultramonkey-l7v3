...
void    load2_unload2_thread(int id, const std::string &modulename)
{
        schedule_module_control_testclass &control = schedule_module_control_testclass::getInstance();
        l7vs::schedule_module_base        *schedule1 = NULL;
        schedule1 = control.load_module2(id, modulename);
        control.unload_module2(id, schedule1);
...
void    load_unload2_thread(int id, const std::string &modulename)
{
        schedule_module_control_testclass &control = schedule_module_control_testclass::getInstance();
        l7vs::schedule_module_base        *schedule1 = NULL;
        schedule1 = control.load_module(modulename);
        control.unload_module2(id, schedule1);
...
void    schedule_module_control_test_thread5()
{
        schedule_module_control_testclass &control = schedule_module_control_testclass::getInstance();
        control.initialize(".");
        schedule_module_control::name_module_info_map &loadmodulemap = control.get_loadmodule_map();
...
//    l7vs::Parameter param;
        ...
        ts->add(BOOST_TEST_CASE(&schedule_module_control_test_thread5));
