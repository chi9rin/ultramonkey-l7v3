...
//	virtual LOG_LEVEL_TAG toLevelTag(log4cxx::LevelPtr level) { return LoggerImpl::toLevelTag(level); }
	...
	std::string getRotationTimingValue() { return normal_log_property.rotation_timing_value_key; }
	int* getLevelTable() { return levelTable; }
	const char *getCategoryTable(LOG_CATEGORY_TAG cat) {
		return category_name_map[cat].c_str(); 
	}
	LOG_CATEGORY_TAG getLoggerCategory(std::string& key) { return name_category_map[key]; }
...
void logger_impl_constructor_test()
{
	...
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_NONE], log4cxx::Level::DEBUG_INT);
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_DEBUG], log4cxx::Level::DEBUG_INT);
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_INFO], log4cxx::Level::INFO_INT);
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_WARN], log4cxx::Level::WARN_INT);
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_ERROR], log4cxx::Level::ERROR_INT);
	BOOST_CHECK_EQUAL(implTest.getLevelTable()[LOG_LV_FATAL], log4cxx::Level::FATAL_INT);
...
#define TEST_LOG_FILE "l7vsd.log"
	...
	//＊ファイル名を取得すること
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	BOOST_CHECK_EQUAL(implTest.getLogFilename(), TEST_LOG_FILE);


	//＊ファイル名が存在しない時にエラーとなること
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "2/8 15:55");
	implTest.loadConf();
	BOOST_CHECK_EQUAL(implTest.getRotation(), LOG_ROT_DATE);

	//＊共通　ローテーションパターンを取得すること　日付サイズ
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "datesize");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "2/8 15:55");
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "sizedate");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	...
	oss << 1LLU + UINT_MAX;
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, oss.str());
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	oss.str("");
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
        implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000K");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "100M");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "2G");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "-100000");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, oss.str());
	implTest.loadConf();
	oss.str("");
	oss.clear(std::stringstream::goodbit);
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY);
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "8 15:55");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "sun 15:55");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15:55");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hour");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "55");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hr");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "55");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05050131");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "0505 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/0501:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 0131");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "/05 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 :31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 01:");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "a/05 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/b 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 c:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 01:d");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "13/05 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/32 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 24:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "05/05 01:60");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "04/31 01:31");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().deleteStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY);
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 18:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "151821");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "1518:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 1821");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, " 18:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 :21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 18:");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "a 18:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 b:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 18:c");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "0 18:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 -1:21");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "month");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "15 18:-15");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 23:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon2359");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon23:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 2359");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, " 23:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon :59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 23:");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "monday 23:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon a:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 23:b");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 99:59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "week");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "mon 23:100");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "12:00");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "1200");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, ":00");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "12:");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "a:00");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "12:b");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "-21:00");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "12:-59");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hour");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "45");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hour");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hour");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "a");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "hour");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "120");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "size");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "5");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	implTest.loadConf();
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "date");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "8");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "2/8 15:55");
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_LOG_FILENAME_KEY, TEST_LOG_FILE);
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "datesize");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "7");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "2/8 15:55");
	...
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_KEY, "datesize");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "12345678");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_KEY, "year");
	l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_ROTATION_TIMING_VALUE_KEY, "2/8 15:55");
	timeSizePolicyCreated = 0;
	implTest.loadConf();
	...
	for (LOG_CATEGORY_TAG cat = implTest.getCategoryRangeStart(LOG_MOD_SNMPAGENT); cat <= implTest.getCategoryRangeEnd(LOG_MOD_SNMPAGENT); ++cat) {
		...
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, implTest.getCategoryTable(cat), "debug");
		implTest.loadConf();
		...
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, implTest.getCategoryTable(cat), "info");
		implTest.loadConf();
		BOOST_CHECK_EQUAL(log4cxx::Logger::getLogger(implTest.getCategoryTable(cat))->getLevel(), log4cxx::Level::getInfo());
		...
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, implTest.getCategoryTable(cat), "warn");
		implTest.loadConf();
		...
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, implTest.getCategoryTable(cat), "error");
		implTest.loadConf();
		...
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_BACKUP_INDEX_KEY, "10");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, LOGGER_MAX_FILE_SIZE_KEY, "1000000");
		l7vs::Parameter::getInstance().setStringValue(PARAM_COMP_LOGGER, implTest.getCategoryTable(cat), "fatal");
		implTest.loadConf();
...
void logger_impl_get_log_level_test()
{
	...
	//＊Logger::getLevelを呼び出してレベルを取得していること
...
#if defined(LOGGER_PROCESS_VSD)
			if (cat >= implTest.getCategoryRangeStart(LOG_MOD_SNMPAGENT) && cat <= implTest.getCategoryRangeEnd(LOG_MOD_SNMPAGENT)) {
				snmpGetLevelReturns = level;

				snmpGetLevelCalled = 0;
				loggerGetLevelCalled = 0;
				BOOST_CHECK_EQUAL(implTest.getLogLevel(cat), level);
				BOOST_CHECK_EQUAL(snmpGetLevelArgCat, cat);
				BOOST_CHECK_EQUAL(snmpGetLevelCalled, 1);
			}
			else {
				log4cxx::Logger::getLogger(implTest.getCategoryTable(cat))->setLevel(log4cxx::Level::toLevel(implTest.getLevelTable()[level]));

				loggerGetLevelCalled = 0;
				if (LOG_LV_NONE == level) {
					//LOG_LV_NONEはLOG4CXXに存在しないため、Debugに変換される
					BOOST_CHECK_EQUAL(implTest.getLogLevel(cat), LOG_LV_DEBUG);
				}
				else {
					BOOST_CHECK_EQUAL(implTest.getLogLevel(cat), level);
				}
				BOOST_CHECK_EQUAL(loggerGetLevelCalled, 1);
			}
	...
	for( LOG_LEVEL_TAG level = LOG_LV_NONE; level <= LOG_LV_FATAL; ++level ){
		for( LOG_CATEGORY_TAG cat = LOG_CAT_NONE; cat <= LOG_CAT_SNMPAGENT_L7VSD_SEND; ++cat ){
			...
			if (cat >= implTest.getCategoryRangeStart(LOG_MOD_SNMPAGENT) && cat <= implTest.getCategoryRangeEnd(LOG_MOD_SNMPAGENT)) {
				...
				snmpChangeLevelCalled = 0;
				snmpChangeLevelArgCat = LOG_CAT_NONE;
				snmpChangeLevelArgLevel = LOG_LV_NONE;
				BOOST_CHECK_EQUAL(implTest.setLogLevel(cat, level), true);
				BOOST_CHECK_EQUAL(snmpChangeLevelCalled, 1);
				BOOST_CHECK_EQUAL(snmpChangeLevelArgCat, cat);
				BOOST_CHECK_EQUAL(snmpChangeLevelArgLevel, level);
			}
			else {
				loggerSetLevelCalled = 0;
				implTest.setLogLevel(cat, level);
				...
				if (LOG_LV_NONE == level) {
					...
					BOOST_CHECK_EQUAL(log4cxx::Logger::getLogger(implTest.getCategoryTable(cat))->getLevel(), implTest.getLevelTable()[level]);
					
				}
				BOOST_CHECK_EQUAL(loggerSetLevelCalled, 1);
			}
