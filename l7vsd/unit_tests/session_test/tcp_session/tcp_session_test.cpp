...
//NG    ts->add( BOOST_TEST_CASE( &thread_state_update_test) );
...
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_disconnect_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorryserver_disconnect_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_connect_event_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_connect_event_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_client_connection_chk_event_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_connection_fail_event_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_connection_fail_event_test) );

//NG    ts->add( BOOST_TEST_CASE( &up_thread_client_receive_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_realserver_receive_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorryserver_receive_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_send_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_send_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_client_send_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_connect_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_connect_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_disconnect_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_realserver_disconnect_test) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_all_realserver_disconnect_test) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_all_realserver_disconnect_test) );

//NG    ts->add( BOOST_TEST_CASE( &up_thread_exit_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_exit_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_client_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_client_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_realserver_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_realserver_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorryserver_disconnect_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorryserver_mod_disconnect_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorryserver_mod_disconnect_test ) );

//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorry_enable_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_sorry_disable_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorry_enable_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_sorry_disable_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_client_accept_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &up_thread_client_respond_event_test ) );
//NG    ts->add( BOOST_TEST_CASE( &down_thread_client_respond_event_test ) );
